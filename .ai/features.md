...
<!-- status flip qa-approved → shipped by /ship 2026-06-13 (oldest-record-age: local-first — shipped = on develop + runs from source; no remote deploy/tag; release smoke = full suite green; UI smoke human-deferred; authorized on the record) -->
