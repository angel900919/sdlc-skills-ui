...
| Hazard‑analysis techniques | **FMEA** (bottom‑up) and **FTA** (top‑down) — KB 04‑se‑tools |
...
- Skills Audit Report Part D — the [high] gap this thread closes (FHA→PHA/SHA, hazard log, RAM allocation, FRACAS, safety case).
- KB: 04‑se‑tools‑techniques — FMEA/FTA, risk management, V&V.
