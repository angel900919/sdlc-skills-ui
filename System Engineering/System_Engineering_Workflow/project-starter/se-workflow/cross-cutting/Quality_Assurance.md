...
- `../00_Skills_Audit_Report.md` — Part A (per-stage findings, incl. the P0 "recompute, don't trust" arithmetic gap QA guards), Part D origin of this thread ("**Quality Assurance (ISO 9001 / 15288 QM)**").
...
- Operated-by stages: `../skills/se-phase-00-agreement/SKILL.md` (QMS framing, QA cadence), `../skills/se-phase-07-verification/SKILL.md` & `../skills/se-phase-08-validation/SKILL.md` (the V&V whose *process* QA audits).
- Template: [`../templates/QA_Plan.md`](../templates/QA_Plan.md) (blank, fill-in).
- KB: `Systems-Engineering-KB/topics/04-se-tools-techniques/fundamentals.md` — V&V via "testing, simulation, and **reviews**"; the verification-vs-validation distinction QA layers process audit on top of.
