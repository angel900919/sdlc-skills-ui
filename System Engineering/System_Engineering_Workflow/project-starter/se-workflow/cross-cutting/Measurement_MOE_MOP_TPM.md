...
- `../00_Skills_Audit_Report.md` — Part D ("Measurement: MOEs/MOPs/TPMs", high priority) — the gap this thread closes.
- KB: `Systems-Engineering-KB/topics/04-se-tools-techniques/fundamentals.md` — V&V and trade-off techniques the measures feed.
