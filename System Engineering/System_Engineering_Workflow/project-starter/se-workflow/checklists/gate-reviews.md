...
**Exit criteria** *(detailed source: `se-phase-00-agreement/SKILL.md` Exit-gate checklist)*
...
**Exit criteria** *(detailed source: `se-phase-01-concept/SKILL.md` Exit-gate checklist)*
...
**Exit criteria** *(detailed source: `se-phase-02-requirements/SKILL.md` Exit-gate checklist (SRR))*
...
**Exit criteria** *(detailed source: `se-phase-04-architecture/SKILL.md` Exit-gate checklist)*
...
**Exit criteria** *(detailed source: `se-phase-06-integration/SKILL.md` Exit-gate checklist)*
...
**Exit criteria** *(detailed source: `se-phase-07-verification/SKILL.md` Exit-gate checklist — TRR)*
...
**Exit criteria** *(detailed source: `se-phase-08-validation/SKILL.md` Exit-gate checklist — PRR)*
...
**Exit criteria** *(detailed source: `se-phase-10-operations/SKILL.md` Exit-gate checklist — ORR)*
...
**Exit criteria** *(detailed source: `se-phase-10-operations/SKILL.md` Exit-gate checklist — GA)*
...
**Exit criteria** *(detailed source: `se-phase-11-disposal/SKILL.md` Exit-gate checklist)*
...
- Producing-stage exit-gate checklists (detailed source per gate): `../skills/se-phase-00-agreement/SKILL.md` · `01` · `02` · `04` · `06` · `07` · `08` · `10` · `11`.
