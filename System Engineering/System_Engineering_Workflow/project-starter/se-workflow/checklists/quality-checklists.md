...
- Producing-stage skills (where each check is applied in context): `02 Requirements` (1, 2) · `03 Modeling` (7) · `04 Architecture` (3) · `05 Tradeoff` (5) · `07 Verification` / `08 Validation` (4) · traceability spine audited at every gate (6).
