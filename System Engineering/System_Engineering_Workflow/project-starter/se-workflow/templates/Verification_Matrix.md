...
> **Pointer, not a copy.** The SAST / DAST / dependency / secrets / IaC / conformance scan-and-tool table is owned by **Phase 06** (`Phase_06_Integration/Integration_Plan.md`). State only each scan's verification **pass-criteria** here.
...
- `../skills/se-phase-07-verification/SKILL.md` — full method, method-choice cheatsheet, exit-gate checklist.
