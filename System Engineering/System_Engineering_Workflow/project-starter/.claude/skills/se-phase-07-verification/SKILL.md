...
## Rules
- **Conform to `../../../se-workflow/05_Conventions.md`** for every ID, gate, method code, severity, baseline, and standard citation. If anything here seems to disagree, Conventions wins — fix here.
...
Blank versions live in [`../../../se-workflow/templates/`](../../../se-workflow/templates/) (`Verification_Matrix.md`, `VnV_Plan.md`).
...
## Cross-cutting hooks
Links live under [`../../../se-workflow/cross-cutting/`](../../../se-workflow/cross-cutting/).
...
## Standards anchor
This phase realises the **ISO/IEC/IEEE 15288:2023 Verification** technical process. It is governed by **IEEE 1012-2016** (V&V — integrity levels, V&V tasks, independence/IV&V), draws its verifiability and SMART/method theory from **ISO/IEC/IEEE 29148:2018** (requirements) and the four-method T/I/A/D set codified in **INCOSE SE Handbook v5 (2023)** and **NASA/SP-2016-6105 Rev 2**. Test documentation that the verification produces follows **ISO/IEC/IEEE 29119-3:2021** (IEEE 829 superseded). Domain integrity schemes — DO-178C, ISO 26262, IEC 62304, IEC 61508 — scale the V&V Plan when invoked. Use the exact citation forms from [`../../../se-workflow/05_Conventions.md`](../../../se-workflow/05_Conventions.md) §9.
...
## References
- [`../../../se-workflow/05_Conventions.md`](../../../se-workflow/05_Conventions.md) — IDs (§2), gates incl. TRR (§3), **T/I/A/D (§4)**, severity (§5), baselines (§3), citations (§9).
- [`../../../se-workflow/01_Workflow_Overview.md`](../../../se-workflow/01_Workflow_Overview.md) — the V-model pairing (Phase 02 ↔ 07), 15288 process map.
