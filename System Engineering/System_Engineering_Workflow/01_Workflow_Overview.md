...
| A specific stage (activities, questions, prompts, deliverables, checklist, exit gate) | [`skills/se-phase-NN-*/SKILL.md`](skills/) |
...
| A fully worked end‑to‑end example | [`worked_example/`](worked_example/) (EV Charging Station Network) |
| What was wrong before and why this exists | [`00_Skills_Audit_Report.md`](00_Skills_Audit_Report.md) |
