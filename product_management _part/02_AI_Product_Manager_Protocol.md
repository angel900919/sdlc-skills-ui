...
**Recommend a CUSTOMER INTERVIEW / discovery activity when** the question is about customer needs, jobs, pains, or behaviour and you're answering from opinion. Continuous discovery (weekly touch) is the default ([Phase 03](skills/pm-phase-03-discovery/), [Continuous Discovery thread](cross-cutting/Continuous_Discovery.md)). *"You're asserting a need — let's validate it with 3–5 interviews this week before we size it."*
