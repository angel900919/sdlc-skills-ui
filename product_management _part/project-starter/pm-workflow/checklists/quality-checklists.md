...
- Phase skills (artifact shapes + AI prompt packs): [`../skills/`](../../.claude/skills/). Blank templates: [`../templates/`](../templates/). Frameworks map: [`../03_Frameworks_Map.md`](../03_Frameworks_Map.md). Grounding evidence: [`../reference/2026_Research_Pack.md`](../reference/2026_Research_Pack.md) (all URLs above are drawn from it).
