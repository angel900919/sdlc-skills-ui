...
> Gate: **G0 Kickoff** — agree the mandate, team, cadence, and decision rights. Source: [`pm-phase-00-charter`](../../.claude/skills/pm-phase-00-charter/SKILL.md).
...
> Gate: **G1 Strategy Sign-off** — decide where we're going and why we'll win. Source: [`pm-phase-01-strategy`](../../.claude/skills/pm-phase-01-strategy/SKILL.md).
...
> Supporting phase (no own gate) — feeds G1/G3. Source: [`pm-phase-02-market-research`](../../.claude/skills/pm-phase-02-market-research/SKILL.md).
...
> Gate: **G2 Problem Validated** — learn the customer, problem, and jobs before solutions. Source: [`pm-phase-03-discovery`](../../.claude/skills/pm-phase-03-discovery/SKILL.md).
...
> Gate: **G3 Opportunity Go/No-Go** — decide which problem is worth solving now. Source: [`pm-phase-04-opportunity`](../../.claude/skills/pm-phase-04-opportunity/SKILL.md).
...
> Gate: **G4 Roadmap Commit** — commit to outcomes over a horizon, not a feature calendar. Source: [`pm-phase-05-roadmap`](../../.claude/skills/pm-phase-05-roadmap/SKILL.md).
...
> Supporting phase (no own gate) — feeds G4/G6. Source: [`pm-phase-06-prioritization`](../../.claude/skills/pm-phase-06-prioritization/SKILL.md).
...
> Gate: **G5 Solution Validated** — find a desirable, usable, feasible, viable (and ethical) solution and de-risk it. Source: [`pm-phase-07-solution-design`](../../.claude/skills/pm-phase-07-solution-design/SKILL.md).
...
> Gate: **G6 PRD Approved / Build Entry** — specify what to build, just enough, just in time. Source: [`pm-phase-08-prd`](../../.claude/skills/pm-phase-08-prd/SKILL.md).
...
> Gate: **G7 Backlog Ready** — turn the PRD into a ready, testable backlog. Source: [`pm-phase-09-stories`](../../.claude/skills/pm-phase-09-stories/SKILL.md).
...
> Gate: **G8 Release Readiness (Go/No-Go)** — build it, keep flow healthy, reach release readiness. Source: [`pm-phase-10-delivery`](../../.claude/skills/pm-phase-10-delivery/SKILL.md).
...
> Gate: **G9 Launch Decision (GA)** — land it in the market with GTM, not just ship it. Source: [`pm-phase-11-launch-gtm`](../../.claude/skills/pm-phase-11-launch-gtm/SKILL.md).
...
> Continuous (recurring health check) — switches on at launch, feeds G8/G9 lines. Source: [`pm-phase-12-analytics`](../../.claude/skills/pm-phase-12-analytics/SKILL.md).
...
> Continuous (per-experiment health check). Source: [`pm-phase-13-experimentation`](../../.claude/skills/pm-phase-13-experimentation/SKILL.md).
...
> Continuous (recurring loop-health check). Source: [`pm-phase-14-feedback`](../../.claude/skills/pm-phase-14-feedback/SKILL.md).
...
> Continuous (recurring health check). Source: [`pm-phase-15-growth`](../../.claude/skills/pm-phase-15-growth/SKILL.md).
...
> Gate: **G10 End-of-Life** — retire a product/feature responsibly. Source: [`pm-phase-16-sunset`](../../.claude/skills/pm-phase-16-sunset/SKILL.md).
