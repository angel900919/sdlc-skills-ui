...
## Used in phases
- Primary: [`pm-phase-04-opportunity`](../../.claude/skills/pm-phase-04-opportunity/), [`pm-phase-07-solution-design`](../../.claude/skills/pm-phase-07-solution-design/).
- Also: the whole measure→grow loop, [`pm-phase-12-analytics`](../../.claude/skills/pm-phase-12-analytics/) → [`pm-phase-15-growth`](../../.claude/skills/pm-phase-15-growth/), and every gate decision (pivot/persevere/kill).
