...
- **Has any product crossed into Decline?** If so, has it been handed to [P16 Sunset](../skills/pm-phase-16-sunset/) with exit criteria, rather than left to limp on by inertia?
...
- **Killing on a single low-usage number** without investigating context (discoverability/onboarding), or treating shutdown as the finish line and ignoring data lifecycle obligations — both handed off and handled in [P16 Sunset](../skills/pm-phase-16-sunset/).
...
---
*Owning artifact:* `_threads/Portfolio_View.md` · *Feeds:* [P16 Sunset](../skills/pm-phase-16-sunset/) · *Companion threads:* [Stakeholder Management](Stakeholder_Management.md), [Responsible Product](Responsible_Product.md) · *Kept alive by:* every phase skill at loop step 7 ([Protocol §7](../02_AI_Product_Manager_Protocol.md)) · *Conforms to* [`../05_Conventions.md`](../05_Conventions.md).
