...
- **P04 Opportunity** — the [Opportunity Solution Tree](../skills/pm-phase-04-opportunity/) is a *living weekly layer*, not a one-time artifact; new `OPP-*` nodes appear as you keep listening.
- **P07 Solution** — story-based interviews surface the assumptions (`ASM-*`) you'll test before you build.
- **P12–P15** — behavioural data and the [feedback loop](../skills/pm-phase-14-feedback/) feed straight back into the tree as fresh opportunities.
