...
- **Roadmap-as-Gantt.** A timeline of dated features is the build trap, not a roadmap. Use Now/Next/Later tied to outcomes ([Phase 05](skills/pm-phase-05-roadmap/)).
...
- **Vanity North Star.** A North Star that goes up while customers churn is the wrong star. It must be a *value-exchange* metric with guardrails ([Phase 12](skills/pm-phase-12-analytics/)).
