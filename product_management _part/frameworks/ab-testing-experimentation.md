...
**Primary source / attribution:** randomized-experiment lineage from R.A. Fisher; the modern online-controlled-experiment canon is Ron Kohavi, Diane Tang & Ya Xu, *Trustworthy Online Controlled Experiments* (Cambridge, 2020), incl. the OEC (Overall Evaluation Criterion). Experimentation is pinned to [pm-phase-13-experimentation](../skills/pm-phase-13-experimentation/) in [`03_Frameworks_Map.md`](../03_Frameworks_Map.md).
...
## Used in phases
- [pm-phase-13-experimentation](../skills/pm-phase-13-experimentation/) (primary)
- [pm-phase-15-growth](../skills/pm-phase-15-growth/)
- [pm-phase-12-analytics](../skills/pm-phase-12-analytics/)
